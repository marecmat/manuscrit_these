    ...
    \begin{tikzpicture}[node distance=3cm]
        ...
        \node (map) [rectangle, rounded corners, text width=5.5cm, minimum height=1cm,text centered, draw=black, below=2cm of init] {Function mapping\\\includegraphics[width=150pt]{det_map.pdf}};
        ...
        \draw [arrow] (init) -- ++ (-5, 0)  -- ++ (0, -5.5) node[arrowlabels] {{\color{accent} if guesses provided}} |- (rootfind) ;
        \draw [arrow] (map) -- (rootfind) node[arrowlabels] {local minima used as guesses};
        \draw [arrow] (rootfind) -- (modeshape)node[arrowlabels, text width=1.5cm] (roots) {set of roots};
