\begin{tikzpicture}
    ...
    \def\arrow{.9}
        ...
        \draw[fill=accent_title!70!white, draw=none] (0, 2*\pad) rectangle ++ (\len, -\pad);
        ...
        \draw[fill=rubber, draw=none] (0, \pad) rectangle ++ (\len, -.6);
        \draw[thick,->] (0,\pad-.6) -- ++ (\arrow, 0) node[above] {$x_1$};
        \draw[thick, ->] (0,\pad-.6) -- ++ (0, \arrow) node[below right] {$x_2$};
    ...
    \draw[->,thick, decorate,decoration={snake,amplitude=3pt,pre length=2pt,post length=3pt}] (\len/2-\pad, -\pad-.25) -- ++ (310:3*\pad) node[right] {};
    ...
    \draw[fill=accent_title!70!white, draw=none] (0, \height) rectangle ++ (\totalen, \rubberthick);
    ...
    \draw[thick,->] (0, -\rubberthick) -- ++ (\arrow, 0) node[above] {$x_1$};
    \draw[thick, ->] (0, -\rubberthick) -- ++ (0, \arrow) node[below right] {$x_2$};
...
\def\cellen{\len} \def\height{2}\def\arrow{.9}\def\totalen{\cellen}
    ...
    \draw[->,thick, decorate,decoration={snake,amplitude=3pt,pre length=2pt,post length=3pt}] (\cellen/2-\pad, -\pad) -- ++ (310:4*\pad) node[right] {};
    \node at (\len/2, 3.8) {Chap. 4};
    \end{scope}  
\end{tikzpicture}